...
export const RESOURCE_CATALOG: Resource[] = [
  // Audit Checklists
  {
    ...
    downloadCount: 347,
    access: 'gated',
    fileUrl: '/resources/external-audit-checklist.pdf',
    thumbnailUrl: '/resources/thumbnails/external-audit-checklist.jpg',
  ...
  },
  {
    ...
    downloadCount: 289,
    access: 'gated',
    fileUrl: '/resources/internal-audit-framework.pdf',
  ...
  },
  {
    ...
    downloadCount: 156,
    access: 'free',
    fileUrl: '/resources/rera-audit-guide.pdf',
  ...
  // Compliance Guides
  {
    ...
    downloadCount: 412,
    access: 'gated',
    fileUrl: '/resources/uae-corporate-governance.pdf',
  ...
  },
  {
    ...
    downloadCount: 298,
    access: 'gated',
    fileUrl: '/resources/aml-compliance-checklist.pdf',
  ...
  },
  {
    ...
    downloadCount: 223,
    access: 'free',
    fileUrl: '/resources/data-protection-guide.pdf',
  ...
  // Tax Templates
  {
    ...
    downloadCount: 567,
    access: 'gated',
    fileUrl: '/resources/vat-compliance-template.xlsx',
  ...
  },
  {
    ...
    downloadCount: 189,
    access: 'gated',
    fileUrl: '/resources/transfer-pricing-documentation.docx',
  ...
  },
  {
    ...
    downloadCount: 634,
    access: 'free',
    fileUrl: '/resources/corporate-tax-readiness.pdf',
  ...
  // Financial Templates
  {
    ...
    downloadCount: 445,
    access: 'gated',
    fileUrl: '/resources/financial-statement-template.xlsx',
  ...
  },
  {
    ...
    downloadCount: 389,
    access: 'free',
    fileUrl: '/resources/cash-flow-forecast.xlsx',
  ...
  },
  {
    ...
    downloadCount: 267,
    access: 'gated',
    fileUrl: '/resources/internal-controls-guide.pdf',
  ...
  // Industry Guides
  {
    ...
    downloadCount: 312,
    access: 'gated',
    fileUrl: '/resources/real-estate-compliance.pdf',
  ...
  },
  {
    ...
    downloadCount: 198,
    access: 'free',
    fileUrl: '/resources/fintech-regulatory-guide.pdf',
  ...
  // Regulatory Updates
  {
    ...
    downloadCount: 423,
    access: 'free',
    fileUrl: '/resources/q1-2025-regulatory-update.pdf',
  ...
  },
  {
    ...
    downloadCount: 245,
    access: 'gated',
    fileUrl: '/resources/esg-reporting-guide.pdf',
