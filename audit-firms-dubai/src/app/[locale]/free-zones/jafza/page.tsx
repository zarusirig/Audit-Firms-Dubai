...
const freeZone = FREE_ZONES['jafza']
...
export default async function JAFZAAuditRequirementsPage({
  params,
}: {
  params: Promise<{ locale: string }>
}) {
    ...
    <>
      ...
      <section className="py-16 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Need JAFZA Audit Services?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Approved auditors for Jebel Ali Free Zone companies. Expert service with competitive pricing.
          </p>
