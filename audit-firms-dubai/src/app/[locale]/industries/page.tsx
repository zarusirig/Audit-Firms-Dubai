                ...
                <Link key={industry.slug} href={`/${locale}/industries/${industry.slug}`}>
                  <Card className="group h-full transition-all duration-300 hover:-translate-y-1 hover:border-primary-300 hover:shadow-xl">
                    <CardHeader>
                      ...
                      <CardTitle className="font-serif text-xl">{industry.name}</CardTitle>
                        ...
                        <div>
                          ...
                          <ul className="space-y-1">
                            {industry.challenges.slice(0, 2).map((challenge) => (
                              <li key={challenge} className="flex items-start gap-2 text-xs text-neutral-600">
                                <CheckCircle2 className="mt-0.5 h-3 w-3 flex-shrink-0 text-primary-600" />
                                <span>{challenge}</span>
                              </li>
                            ))}
                          </ul>
