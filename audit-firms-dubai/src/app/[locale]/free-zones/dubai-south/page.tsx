...
const freeZone = FREE_ZONES['dubai-south']
...
export default async function DubaiSouthAuditRequirementsPage({
  params,
}: {
  params: Promise<{ locale: string }>
}) {
    ...
    <>
      ...
      <section className="py-16 bg-gradient-to-br from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Need Dubai South Audit Services?</h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Ministry-approved auditors for Dubai South (DWC) companies. Aviation and logistics expertise.
          </p>
