...
const complianceData = COMPLIANCE_PAGES['ministry-requirements']
...
export default async function MinistryRequirementsPage({
  params,
}: {
  params: Promise<{ locale: string }>
}) {
    ...
    <>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-bold mb-12 text-center">Filing Requirements Checklist</h2>
      ...
      {complianceData.timeline && (
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold mb-12 text-center">Ministry Filing Timeline</h2>
