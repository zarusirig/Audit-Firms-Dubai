...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const data = await serverLoaders.getIndustryBySlug('manufacturing')
  if (!data) {
...
export default async function ManufacturingIndustryPage({ params }: { params: Promise<{ locale: string }> }) {
  const data = await serverLoaders.getIndustryBySlug('manufacturing')
