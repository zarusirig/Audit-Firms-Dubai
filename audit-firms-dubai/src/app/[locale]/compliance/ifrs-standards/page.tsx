    ...
    <>
      ...
      <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            {complianceData.heroHeadline}
          </h1>
          <p className="text-xl md:text-2xl mb-6 opacity-90">
            {complianceData.heroSubheadline}
          </p>
          <p className="text-lg opacity-80 max-w-3xl">
            {complianceData.heroDescription}
          </p>
        </div>
      </section>
        ...
        >
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            {section.content.map((paragraph, pIndex) => (
              <p
                key={pIndex}
                className="text-lg text-gray-700 mb-4 leading-relaxed whitespace-pre-line"
              >
                {paragraph}
              </p>
            ))}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-bold mb-12 text-center">Other Important IFRS Standards</h2>
      ...
      {complianceData.timeline && (
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold mb-12 text-center">IFRS Implementation Timeline</h2>
      ...
      <section className="py-16 bg-primary-600 text-white">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          <h2 className="text-3xl font-bold mb-6">Need Help with IFRS Compliance?</h2>
          <p className="text-xl mb-8 opacity-90">
            Our IFRS specialists can help you navigate complex standards and ensure full compliance.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={`/${locale}/services/ifrs-implementation`}
            ...
            <a
              href={`/${locale}/contact`}
              className="bg-primary-700 text-white px-8 py-4 rounded-lg font-bold hover:bg-primary-800 transition-colors border-2 border-white"
            >
